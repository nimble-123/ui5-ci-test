sap.ui.define([
	...
	return BaseObject.extend("de.nlsltz.test.ci.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias de.nlsltz.test.ci.model.ListSelector
		 */
		 ...
		 * @return {de.nlsltz.test.ci.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
