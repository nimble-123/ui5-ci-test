/*global history */
sap.ui.define([
	"de/nlsltz/test/ci/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"de/nlsltz/test/ci/model/formatter",
	"sap/m/MessageBox",
	"de/nlsltz/test/ci/model/grouper",
	"de/nlsltz/test/ci/model/GroupSortState"
], function(BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("de.nlsltz.test.ci.controller.Master", {
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("de.nlsltz.test.ci.view.ViewSettingsDialog", this);
